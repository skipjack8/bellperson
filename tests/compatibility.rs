...
use blstrs::{Bls12, Compress, Fp12 as Fq12, G1Affine, G1Projective, G2Affine, G2Projective};
...
fn compute_test_vector<R: RngCore>(r: &mut R) -> TestVector {
    ...
    let gt: Fq12 = Bls12::multi_miller_loop(&[(&g1, &g2.into())])
...
fn verify_test_vector(t: TestVector) {
    ...
    let gtexp: Fq12 = Bls12::multi_miller_loop(&[(&g1, &g2.into())])
        .final_exponentiation()
        .into();
